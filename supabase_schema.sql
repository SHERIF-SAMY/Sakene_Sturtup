...
create table if not exists profiles (
  ...
  phone       text,
  avatar      text,
  role        text not null default 'student' check (role in ('student','broker','admin')),
...
create table if not exists properties (
  ...
  status         text default 'pending' check (status in ('pending','active','inactive','rejected','archived')),
